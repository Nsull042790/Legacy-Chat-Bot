...
(function() {
  ...
  var KNOWLEDGE = {
    ...
    down_payment_assistance: { patterns: ['down payment assistance', 'down payment help', 'assistance program', 'dpa', 'grant', 'help with down payment', 'state program', 'state programs'], response: "Great news — nearly <strong>2,500 DPA programs</strong> exist nationwide!\n\n<strong>2025 Stats:</strong>\n• Average assistance: <strong>$18,000</strong>\n• Available in ALL 3,143 U.S. counties\n• Can reduce LTV by up to 6%\n\n<strong>Can Be Used For:</strong>\n• Down payment or closing costs\n• Buying down your interest rate\n• Reducing or eliminating PMI\n\n<strong>State Programs We Offer:</strong>\n• <strong>New Jersey:</strong> Smart Start (up to $15,000!)\n• <strong>Pennsylvania:</strong> Keystone, K-FIT\n• <strong>New York:</strong> SONYMA programs\n\nYou may combine multiple programs!", quickReplies: ['New Jersey', 'Pennsylvania', 'New York', 'Other state'] },
    ...
    student_loans: { patterns: ['student loan', 'student loans', 'student debt', 'college debt', 'college loan'], response: "Yes, you CAN get a mortgage with student loans!\n\n<strong>What Lenders Consider:</strong>\n• Your debt-to-income (DTI) ratio\n• Payment history on student loans\n• Overall credit score\n\n<strong>Important 2025 Update:</strong>\n• Student loan delinquencies now appear on credit reports\n• Over 15% of borrowers are behind on payments\n• Late payments can drop your score 87-150+ points!\n\n<strong>Options If You're Struggling:</strong>\n• Income-driven repayment plans\n• Deferment or forbearance\n• Visit StudentAid.gov for help\n\nWe specialize in finding solutions for borrowers with student debt!", quickReplies: ['Check my options', 'DTI info', 'Talk to specialist'] },

    dti: { patterns: ['dti', 'debt to income', 'debt-to-income', 'debt ratio', 'income ratio'], response: "Debt-to-Income (DTI) is crucial for mortgage approval!\n\n<strong>How It's Calculated:</strong>\nMonthly debts ÷ Gross monthly income\n\n<strong>DTI Guidelines:</strong>\n• Conventional: Up to 45-50%\n• FHA: Up to 57% with compensating factors\n• VA: No strict limit, but 41% preferred\n\n<strong>What Counts as Debt:</strong>\n• Student loans\n• Car payments\n• Credit card minimums\n• Child support/alimony\n• Existing mortgage payments\n\nHigh DTI? We have options including Non-QM loans!", quickReplies: ['Student loans', 'Non-QM loans', 'Talk to specialist'] },

    value_assurance: { patterns: ['value assurance', 'cash buyer', 'cash buyers', 'compete with cash', 'appraisal contingency', 'waive appraisal', 'beat cash', 'cash offer'], response: "Struggling to compete with cash buyers? Meet our <strong>Value Assurance Program!</strong>\n\n<strong>How It Works:</strong>\n• We guarantee the property value for underwriting\n• Uses Automated Valuation Model (AVM) data\n• If home doesn't appraise, we honor the AVM value!\n\n<strong>Benefits:</strong>\n• Bid with full confidence\n• No appraisal contingency worries\n• Compete with cash offers\n• Reduce financial risk\n\n<strong>Requirements:</strong>\n• Must meet LTV and FICO qualifications\n• Single-family homes and condos only\n• Conforming and High Balance loans\n• MLS listing required\n\nPut the power back in YOUR hands!", quickReplies: ['How to qualify', 'Get pre-approved', 'Talk to specialist'] },

    gift_funds: { patterns: ['gift fund', 'gift funds', 'gift money', 'family gift', 'gift for down payment'], response: "Gift funds can help with your down payment!\n\n<strong>Who Can Gift (FHA Loans):</strong>\n• Family members\n• Employers or labor unions\n• Close friends (documented relationship)\n• Charitable organizations\n• Government agencies\n\n<strong>Requirements:</strong>\n• Gift letter required\n• Donor bank statements may be needed\n• Cannot be a loan — must be a true gift\n\nGift funds can cover 100% of down payment on FHA loans!", quickReplies: ['FHA loans', 'Down payment options', 'Talk to specialist'] },
